...
path_group.add_argument('--graph_dir', type=str, default="/media/F/FERDataset/AER-DB/RAER/graph")
...
def run_training(args: argparse.Namespace) -> None:
    ...
    print("Class Name")
    print(class_names)
    class_weights = calculate_class_weights(args, class_names)
    ...
    optimizer = torch.optim.SGD([
        ...
        # {"params": model.temporal_net_graph.parameters(), "lr": args.lr},
        # {"params": model.gnn_encoder.parameters(), "lr": args.lr_image_encoder},

...
class Trainer:
    ...
    def _run_one_epoch(self, loader, epoch_str, is_train=True):
        ...
        with context:
            for i, (images_face, images_body, x, pos, edge_index, edge_attr, batch, target) in enumerate(loader):
                ...
                # Forward pass
                output = self.model(images_face, images_body, x, pos, edge_index, edge_attr, batch)
